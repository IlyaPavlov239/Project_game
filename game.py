    ...
    def is_red(cars):
        ...
        for i in cars:
            if i.orientation == "horizontal":
                if  i.rect.center[0] > s[0].center[0] - 15 and i.rect.center[0]<s[0].center[0] and i.direction==1 and not sw[0]:
                    i.stop()
                elif  i.rect.center[0] < s[1].center[0] + 15 and i.rect.center[0]>s[1].center[0] and i.direction==-1 and not sw[1]:
                    i.stop()

            else:
                if i.rect.center[1] > s[2].center[1] - 15 and i.rect.center[1]<s[2].center[1] and i.direction==1 and not sw[2]:
                    i.stop()
                elif  i.rect.center[1] < s[3].center[1] + 15 and i.rect.center[1]>s[3].center[1] and i.direction==-1 and not sw[3]:
                    i.stop()
